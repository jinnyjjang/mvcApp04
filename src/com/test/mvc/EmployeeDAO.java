...
public class EmployeeDAO implements IEmployeeDAO
{
	...
	public ArrayList<Employee> list() throws SQLException
	{
		...
		String sql = "SELECT EMPLOYEEID, NAME, SSN, BIRTHDAY, LUNAR, LUNARNAME, TELEPHONE, DEPARTMENTID, DEPARTMENTNAME, POSITIONID, POSITIONNAME , REGIONID, REGIONNAME , BASICPAY, EXTRAPAY, PAY, GRADE FROM EMPLOYEEVIEW";
	...
	public int employeeAdd(Employee employee) throws SQLException
	{
		...
		String sql = "INSERT INTO EMPLOYEE( EMPLOYEEID, NAME, SSN1, SSN2, BIRTHDAY, LUNAR, TELEPHONE,  DEPARTMENTID, POSITIONID, REGIONID, BASICPAY, EXTRAPAY) VALUES( EMPLOYEESEQ.NEXTVAL, ?, ?, CRYPTPACK.ENCRYPT(?, ?), TO_DATE(?, 'YYYY-MM-DD'), ? , ?, ?, ?, ?, ?, ?)";
		PreparedStatement pstmt = conn.prepareStatement(sql);
	...
	public int modify(Employee employee) throws SQLException
	{
		...
		String sql = "UPDATE EMPLOYEE SET NAME=?, SSN1=?, SSN2=CRYPTPACK.ENCRYPT(?,?), BIRTHDAY=TO_DATE(?, 'YYYY-MM-DD'), LUNAR=?, TELEPHONE=?, DEPARTMENTID=?, POSITIONID=?, REGIONID=?, BASICPAY=?, EXTRAPAY=? WHERE EMPLOYEEID=?";
		PreparedStatement pstmt = conn.prepareStatement(sql);
		pstmt.setString(1, employee.getName());
		pstmt.setString(2, employee.getSsn1());
		pstmt.setString(3, employee.getSsn2());
	...
	public Employee searchId(String employeeId) throws SQLException
	{
		...
		String sql = "SELECT EMPLOYEEID, NAME, SSN1, TO_CHAR(BIRTHDAY, 'YYYY-MM-DD') AS BIRTHDAY, LUNAR, TELEPHONE, DEPARTMENTID, POSITIONID, REGIONID, BASICPAY, EXTRAPAY FROM EMPLOYEE WHERE EMPLOYEEID=?";
		PreparedStatement pstmt = conn.prepareStatement(sql);
