			...
			<table>
				...
				<tr>
					...
					<td>
						...
						style="width: 100px;"> -
						<input type="password" in="ssn2" name="ssn2"
						style="width: 110px;">
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="2" align="center">
						...
						<br><br>
						<!-- 에러 메세지 출력 -->
						<span id="err" style="color: red; font-weight: bolid; display: none;"></span>
					</td>
				</tr>
			</table>
		</form>
